...
(defun run-gilded-rose (days)
  (io:format "TextTest~n")
  (let ((items (list (make-item name "Vest" sellin 10 quality 20)
                     (make-item name "Aged Brie" sellin 2 quality 0)
                     (make-item name "Juice" sellin 5 quality 7)
                     (make-item name "Diamond" sellin 0 quality 80)
                     (make-item name "Diamond" sellin -1 quality 80)
                     (make-item name "Backstage passes" sellin 15 quality 20)
                     (make-item name "Backstage passes" sellin 10 quality 49)
                     (make-item name "Backstage passes" sellin 5 quality 49)
                     ;; this conjured item does not work properly yet
                     (make-item name "Bio Cake" sellin 3 quality 6))))
