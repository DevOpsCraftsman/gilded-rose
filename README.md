...
## Notice
This is a modified version of the original repository using only neutral names for items,
without references to video games, fantasy world nor magical concepts.
...
Most language versions of this code have a [TextTest](https://texttest.org) fixture for Approval testing. For information about this, see the [TextTests README](texttests/README.md)
