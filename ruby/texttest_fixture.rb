...
items = [
  ...
  Item.new(name="Juice", sell_in=5, quality=7),
  Item.new(name="Diamond", sell_in=0, quality=80),
  Item.new(name="Diamond", sell_in=-1, quality=80),
  ...
  Item.new(name="Bio Cake", sell_in=3, quality=6), # <-- :O
]
